...
export default function Acheivments(){
  return (
    <section id="acheivments" className="acheivments">
      <div className="acheivments-inner">
        <h2 className="acheivments-title">حصاد مجلس رأس الخيمة للشباب</h2>
        <p className="acheivments-sub">فبراير - أغسطس 2025</p>
