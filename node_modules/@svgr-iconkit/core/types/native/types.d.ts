...
export type NativeIconBaseComponentProps<IconNames extends string, IconVariant extends string> = IconComponentCoreProps<IconNames, IconVariant, NativeIconBaseProps, NativeIconRefType>;
export type NativeIconBaseComponentType<IconNames extends string, IconVariant extends string> = NativeIconBaseComponentProps<IconNames, IconVariant>;
export type NativeIconsetBaseComponentType<IconNames extends string, IconVariant extends string> = IconsetComponentCoreType<IconNames, IconVariant, NativeIconBaseProps, NativeIconRefType>;
