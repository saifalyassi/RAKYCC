...
export type WebIconBaseComponentProps<IconNames extends string, IconVariant extends string> = IconComponentCoreProps<IconNames, IconVariant, WebIconBaseProps, WebIconRefType>;
export type WebIconBaseComponentType<IconNames extends string, IconVariant extends string> = WebIconBaseComponentProps<IconNames, IconVariant>;
export type WebIconsetBaseComponentType<IconNames extends string, IconVariant extends string> = IconsetComponentCoreType<IconNames, IconVariant, WebIconBaseProps, WebIconRefType>;
